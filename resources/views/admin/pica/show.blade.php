...
@section('content')
<div class="mb-6">
    <a href="{{ route('admin.pica.index') }}" class="text-gray-400 hover:text-gray-600 text-sm">← Kembali</a>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
        ...
        <div>
            <p class="text-xs text-gray-400 mb-1">Auditor MD</p>
