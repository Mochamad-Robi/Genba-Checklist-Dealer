...
<div class="max-w-lg">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800">Edit Dealer</h2>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-6">
        <form method="POST" action="{{ route('admin.dealers.update', $dealer) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="code" value="{{ old('code', $dealer->code) }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" value="{{ old('name', $dealer->name) }}"
                    class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-red-500" required>
            ...
            <div class="mb-4">
                ...
                <textarea name="address" rows="2"
                    class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-red-500">{{ old('address', $dealer->address) }}</textarea>
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1">Telepon</label>
                <input type="text" name="phone" value="{{ old('phone', $dealer->phone) }}"
                    class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-red-500">
            </div>
            <div class="mb-6">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="is_active" value="1"
                        {{ $dealer->is_active ? 'checked' : '' }} class="rounded">
